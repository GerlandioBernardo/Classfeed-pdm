    ...
    return (
      ...
      >
        <View style={styles.cardHeader}>
          ...
          <View
            style={[styles.badge, { backgroundColor: item.status === "Ativo" ? COLORS.success : COLORS.text.light }]}
          >
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>Crie uma turma ou entre em uma através de um link de convite</Text>
          </View>
        }
      />
    </View>
